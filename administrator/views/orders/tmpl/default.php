...
<form action="<?php echo JRoute::_('index.php?option=com_catalogue&view=cart'); ?>" method="post" name="adminForm" id="adminForm">
							...
							<td class="has-context">
								<div class="pull-left break-word">
									...
									<?php if ($canEdit || $canEditOwn) : ?>
										<a class="hasTooltip"
										   href="<?php echo JRoute::_('index.php?option=com_catalogue&task=cart.edit&id=' . $item->id); ?>"
